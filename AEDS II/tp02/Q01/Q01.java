...
public class Q01 {
    public static void main(String[] args) {
        ...
        ArrayList<Pokemon> pokemons = new ArrayList<>(); // Lista para armazenar os Pokémon encontrados
        
        while (!entrada.equals("FIM")) {
            String id = entrada.trim();
            
            Pokemon pokemon = new Pokemon();
            pokemon.read(id); // Lê os dados do Pokémon a partir do ID
            pokemons.add(pokemon); // Adiciona o Pokémon à lista
            entrada = sc.nextLine();
        }

        // Imprime os dados de todos os Pokémon encontrados
